...
{
    class MathMultiplyNodeFactory : IControlNodeFactoryPlugin
    {
        public const string TYPESTRING = "Math.Multiply"; // Type for note display and save/load
        public const string NODEMENU = "Math"; // Menu, / delimited
        public const string NAME = "Multiply"; // Name in menu

        public string TypeString { get { return TYPESTRING; } }
        public string NodeMenu { get { return NODEMENU; } }
        public string Name { get { return NAME; } }

        public MathMultiplyNodeFactory()
        {
        ...
        {
            return new MathMultiplyNode();
        }

        public NodeViewModel CreateNode(JObject data, Guid[] executeIn, Guid[] executeOut, Guid[] dataIn, Guid[] dataOut)
        {
            return new MathMultiplyNode(data, executeIn, executeOut, dataIn, dataOut);
        }
    }

    class MathMultiplyNode : NodeViewModel
    {
        ...
        public override string Type { get { return MathMultiplyNodeFactory.TYPESTRING; } }
        ...
        public MathMultiplyNode() : base(MathMultiplyNodeFactory.TYPESTRING)
        {
            // Prepare Connections
        ...
        public MathMultiplyNode(JObject data, Guid[] executeIn, Guid[] executeOut, Guid[] dataIn, Guid[] dataOut) : base(MathMultiplyNodeFactory.TYPESTRING)
        {
            // Prepare Connections
            conOut = new ConnectorViewModel("Product", typeof(NodeDataNumeric), dataOut[0]);
